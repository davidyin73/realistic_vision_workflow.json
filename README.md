# realistic_vision_workflow.json

Dockerized ComfyUI workflow: realistic_vision_workflow.json
...
docker build -t realistic_vision_workflow.json .

# Run the container
docker run -p 8188:8188 realistic_vision_workflow.json
```
